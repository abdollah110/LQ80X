...
// ------------>Primitives in pad: pad_leg
   ...
   entry->SetTextFont(62);
    ...
    entry=leg->AddEntry("Graph1","Theory (M_{Nu}=M_{W}/2)","L");
...
// ------------>Primitives in pad: pad_plot
   ...
   pad_plot->Draw();
   pad_plot->cd();
   pad_plot->Range(500,-4.731707,4666.667,1.365854);
   ...
   hist1d__1->GetYaxis()->SetTitle("#sigma#font[42]{}(pp#rightarrow W_{R})#times B(W_{R}#rightarrow#tau#taujj)[pb]");
   ...
   graph->Draw("l");
    ...
    ///////  Just two points
    Double_t Graph0_XXX[6] = {
       
        3000,
        3000};
    Double_t Graph0_XXXy[6] = {
               0.00634765625,
        0.00341796875
       };
    TGraph *graph2 = new TGraph(2,Graph0_XXX,Graph0_XXXy);
    graph2->SetName("Graph0");
...
//    Double_t xsTh[nTH] = {1.692E0,2.9E-1,6.563E-02,1.92E-02,6.030E-03,1.92E-03,6.030E-04};
    ...
    hist1d__2->GetYaxis()->SetTitle("#sigma#font[42]{}(pp#rightarrow W_{R})#times B(W_{R}#rightarrow#tau#taujj)[pb]");
