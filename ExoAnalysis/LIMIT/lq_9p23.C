...
//=========  (Wed Jul 20 13:04:26 2016) by ROOT version6.04/14
   TCanvas *c1 = new TCanvas("c1", "c1",195,58,600,600);
...
// ------------>Primitives in pad: pad_leg
   TPad *pad_leg = new TPad("pad_leg", "pad_leg",0.5,0.72,0.9,0.9);
   pad_leg->Draw();
   pad_leg->cd();
...
// ------------>Primitives in pad: pad_plot
   ...
   Graph_Graph3001->SetMinimum(0.001235962);
   Graph_Graph3001->SetMaximum(11.41096);
   ...
   Graph_Graph3002->SetMinimum(0.00225563);
   Graph_Graph3002->SetMaximum(7.863322);
   ...
   Graph_Graph1->SetMinimum(0.003955078);
   ...
   Graph_Graph2->SetMinimum(0.004140072);
   Graph_Graph2->SetMaximum(3.770932);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.96,0.952,"CMS Preliminary       6.26 fb^{-1} (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
