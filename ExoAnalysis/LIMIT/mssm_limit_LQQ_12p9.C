...
// ------------>Primitives in pad: pad_plot
   ...
   Graph_Graph3001->SetMinimum(0.001153564);
   Graph_Graph3001->SetMaximum(9.987187);
   ...
   Graph_Graph3002->SetMinimum(0.001874542);
   Graph_Graph3002->SetMaximum(6.993251);
   ...
   Graph_Graph1->SetMinimum(0.003076172);
   Graph_Graph1->SetMaximum(4.794971);
   ...
   Graph_Graph2->SetMinimum(0.002995069);
   Graph_Graph2->SetMaximum(4.636619);
