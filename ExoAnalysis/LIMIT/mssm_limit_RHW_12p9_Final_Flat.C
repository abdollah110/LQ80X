...
void mssm_limit_RHW_12p9_Final_Flat()
{
...
//=========  (Wed Jul 27 09:42:19 2016) by ROOT version6.04/14
   ...
   hist1d__1->Draw("");
    ...
    Double_t XS[7] = {1.692E0,2.9E-1,6.563E-02,1.92E-02,6.030E-03,0.00209,0.000801};
    
    for (int x=0; x<6;x++){
       cout<<Graph1_fx2[x] <<" expected "<<Graph0_fy1[x]/XS[x] << " obs="<<Graph1_fy2[x]/XS[x]<<"\n";
        
        double result = intersection(Graph1_fx2[x], Graph1_fx2[x+1], 1, 1, Graph1_fy2[x]/XS[x], Graph1_fy2[x+1]/XS[x+1]);
        cout <<"res="<<result<<"\n";
