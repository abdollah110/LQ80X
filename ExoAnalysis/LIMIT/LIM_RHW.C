...
//=========  (Wed Aug  3 12:09:33 2016) by ROOT version6.04/14
...
// ------------>Primitives in pad: pad_plot
   ...
   pad_plot->Draw();
   pad_plot->cd();
   pad_plot->Range(535.7143,-4.731707,4404.762,1.365854);
   ...
   TH1F *hist1d__1 = new TH1F("hist1d__1","",7,1000,4250);
...
tex->SetNDC();
   ...
   TH1F *hist1d__2 = new TH1F("hist1d__2","",7,1000,4250);
