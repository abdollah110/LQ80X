                                                                        ...
                                                                        if (ST_category[ist]) {
                                                                            ...
                                                                            for (int trg = 0; trg < size_trgCat; trg++) {
                                                                                ...
                                                                                if (Trigger_category[trg]) {
                                                                                    ...
                                                                                    plotFill(CHANNEL+AN_Cat[an]+"_ST_MET"+FullStringName,JetVector.size(),10,0,10,FullWeight);
                                                                                    ...
                                                                                    if ( scale==1 && jetScl==1){
                                                                                        plotFill(CHANNEL+AN_Cat[an]+"_ST_MET_BtagUp"+FullStringName,JetVector.size(),10,0,10,FullWeight  * BtagSFLeadBJetUp/BtagSFLeadBJet) ;
                                                                                        plotFill(CHANNEL+AN_Cat[an]+"_ST_MET_BtagDown"+FullStringName,JetVector.size(),10,0,10,FullWeight * BtagSFLeadBJetDown/BtagSFLeadBJet) ;
                                                                                        
                                                                                        
                                                                                        plotFill(CHANNEL+AN_Cat[an]+"_ST_METTauHighPtRWDown"+FullStringName,JetVector.size(),10,0,10,FullWeight *  tauPtReweightingDown);
                                                                                        plotFill(CHANNEL+AN_Cat[an]+"_ST_METTauHighPtRWUp"+FullStringName,JetVector.size(),10,0,10,FullWeight * tauPtReweightingUp);
                                                                                        
                                                                                        if (isTTJets!= string::npos) plotFill(CHANNEL+AN_Cat[an]+"_ST_METTopPtRWUp"+FullStringName,JetVector.size(),10,0,10,FullWeight * TopPtReweighting);
                                                                                        if (isTTJets!= string::npos) plotFill(CHANNEL+AN_Cat[an]+"_ST_METTopPtRWDown"+FullStringName,JetVector.size(),10,0,10,FullWeight / TopPtReweighting);
                                                                                    }
