...
def MakeTheHistogram(channel,NormMC,NormQCD,ShapeQCD,CoMEnergy,chl,Binning):
    ...
    #            NormFile= _FileReturn(Name, channel,NameCat, NormQCD, TauScale[tscale],CoMEnergy)
    #            NormHisto=NormFile.Get("XXX")
    #            
    #            ShapeFile= _FileReturn(Name, channel,NameCat, ShapeQCD, TauScale[tscale],CoMEnergy)
    #            ShapeHisto=ShapeFile.Get("XXX")
    ...
    #            tDirectory.WriteObject(RebinedHist,NameOut)
                ...
                tauFRNum=_FileReturn(Name, channel,"_inclusive", NormMC.replace("_HighMT_OS","_SS")+"_TauIso", TauScale[tscale],CoMEnergy)
                tauFRNumHist=tauFRNum.Get("XXX")
                print tauFRNumHist.Integral()
                
                lepFRNum=_FileReturn(Name, channel,"_inclusive", NormMC.replace("_HighMT_OS","_SS")+"_LepIso", TauScale[tscale],CoMEnergy)
                lepFRNumHist=lepFRNum.Get("XXX")
                print lepFRNumHist.Integral()

                lepFRDeNum=_FileReturn(Name, channel,"_inclusive", NormMC.replace("_HighMT_OS","_SS")+"_Total", TauScale[tscale],CoMEnergy)
                lepFRDeNumHist=lepFRDeNum.Get("XXX")
                print lepFRDeNumHist.Integral()
        
                jetFRNum=_FileReturn(Name, channel,NameCat, NormMC.replace("_HighMT_OS","_SS")+"_Total", TauScale[tscale],CoMEnergy)
                jetFRNumHist=jetFRNum.Get("XXX")
                print jetFRNumHist.Integral()
                
                jetFRDeNum=_FileReturn(Name, channel,"_inclNoBjet", NormMC.replace("_HighMT_OS","_SS")+"_Total", TauScale[tscale],CoMEnergy)
                jetFRDeNumHist=jetFRDeNum.Get("XXX")
                print jetFRDeNumHist.Integral()

                XValu=_FileReturn(Name, channel,NameCat, NormMC+"_Total", TauScale[tscale],CoMEnergy)  #definedabove
